...
class SingletonService
    {
        ...
        public List<UsuarioAnilist> Usuarios
        {
            get
            {
                return usuarios;
        ...
        {
            // Precondicion: Haber verificado que tenga cooldown antes
            ...
            bool rellenarDiasFaltantes = true)
        {
            ...
            if (!rellenarDiasFaltantes)
            {
                ...
                // Si falta el registro de hoy, lo agregamos solo en memoria
            ...
            // Rellenar días faltantes SOLO para el año actual
            if (registrosActual.Count > 0)
            {
                ...
                while (startDate <= endDate)
                {
                    ...
                    else if (includeZeroXp || lastXp != 0)
                    {
                        ...
                        if (lastXp != 0)
                        {
                            // Solo escribe en la base si hay XP previo
                ...
                if (modified)
                {
                    // Actualiza el cache local si se agregaron registros
