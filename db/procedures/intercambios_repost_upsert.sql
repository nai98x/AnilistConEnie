-- Crea o actualiza el mapeo de un mensaje de intercambio a un repost (una fila por canal de repost).
...
AS $$
    ...
    ON CONFLICT (id_mensaje_hilo_foro, id_canal_mensaje_repost) DO UPDATE
